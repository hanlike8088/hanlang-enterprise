...
const menuItems = [
  {
    ...
    children: [
      ...
      { key: '/plm/products', icon: <DatabaseOutlined />, label: 'PLM产品' },
      { key: '/plm/documents', icon: <FileTextOutlined />, label: 'PLM文档' },
      ...
      { key: '/spc', icon: <LineChartOutlined />, label: 'SPC控制图' },
      { key: '/equipment', icon: <ToolOutlined />, label: '设备台账' },
      { key: '/equipment/tpm', icon: <CheckCircleOutlined />, label: 'TPM点检' },
  ...
  return (
    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      >
        ...
        <Menu
          mode="inline"
          defaultOpenKeys={['public', 'business']} selectedKeys={[selectedKey]}
